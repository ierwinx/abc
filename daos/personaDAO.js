...
var creaPersona = async(cantidad, complemento) => {
    ...
    for (var x = 0; x < cantidad; x++) {
        ...
        var nueva = {
            ...
            pais_cu: valida(personaEncontradas[Math.floor(Math.random() * cant)].pais_cu),
            canal_cu: valida(personaEncontradas[Math.floor(Math.random() * cant)].canal_cu),
            sucursal_cu: valida(personaEncontradas[Math.floor(Math.random() * cant)].sucursal_cu),
            folio_cu: valida(personaEncontradas[Math.floor(Math.random() * cant)].folio_cu),
